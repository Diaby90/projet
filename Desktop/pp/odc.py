...
bouton=Button(a,text="se connecter",font=("Arial", 15), width=17, height=1,  fg="white",bg="#5C4D4D")
bouton.place(x=200,y=300)

bouton1=Button(a,text="s'inscrire",font=("Arial", 15), width=17, height=1,  fg="white",bg="#5C4D4D")
